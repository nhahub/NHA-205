...
if (!loginForm || !emailInput || !passwordInput || !emailError || !passwordError) {
    console.log('Login form elements not found, skipping signin.js initialization');
    ...
    loginForm.addEventListener('submit', (e) => {
        ...
        // If form is valid, allow natural form submission to server
        // The form will POST to /Account/Login as configured in the HTML
    });
